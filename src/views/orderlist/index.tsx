...
const OrderDetailPage: React.FC = () => {
  ...
  const [orderDatetime, setOrderDatetime] = useState<string>('N/A');
  ...
  useEffect(() => {
    ...
    const fetchOrderList = async () => {
      ...
      if (response) {
        ...
        setOrderDatetime(response.orderDatetime);
        // console.log(response.orderItems.orderDatetime)
      } else {
        setOrderItems([]);
      }
    };
            ...
            <td>
              <div className="icon-button">
                <div
                  ...
                  onClick={() =>
                    deleteButtonClickHandler(product)
                  }
                ></div>
              </div>
            </td>
